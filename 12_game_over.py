...
def display_game_over():
    global game_font, WHITE
    text_game_over = game_font.render(game_result, True, WHITE)
    rect_game_over = text_game_over.get_rect(center=(screen_width // 2, screen_height // 2))
...
while running:
    ...
    if not bubble_group:
        ...
        is_game_over = True
    elif get_lowest_bubble_bottom() > len(bubble_map) * CELL_SIZE:
